...
export class MyVehicleViewPage implements OnInit {
        ...
        async data => {
          if(data && data.status === "SUCCESS") {
            ...
            try {
              ...
              this.vehicleInfo.breakingSystem = allArr[6];
  ...
  getVehicleBreakingSystem(vehicleBreakingSystemId: number) {
    return new Promise((res,rej) => {
      this.myVehicleViewService.getVehicleBreakingSystem(vehicleBreakingSystemId).subscribe(data => {
